...
public class JobSchedulingInfoHolderTest {
    ...
    public void testSubCounting() {
        ...
        when(mc.getSchedulingChanges(any())).thenReturn(schedObs);
        int cLatchCnt1 = 5;
        int cLatchCnt2 = 3;
        int cLatchCnt4 = 2;
        ...
        JobSchedulingInfoSubjectHolder jsis = new JobSchedulingInfoSubjectHolder(mc,
                "j1", o -> {
    ...
    public void testJobSchedulingObsErrors() {
        ...
        Thread thread1 = new Thread(() -> jsis.getSchedulingChanges()
        ...
        Thread thread2 = new Thread(() -> jsis.getSchedulingChanges()
    ...
    public static Thread getThread1(int cLatchCnt1, CountDownLatch cLatch1, JobSchedulingInfoSubjectHolder jsis) {
        return new Thread(() -> jsis.getSchedulingChanges()
                .map((d) -> {
                    cLatch1.countDown();
                    return d;
                })
    ...
    public void testSubCountingWithManager() {
        ...
        JobSchedulingInfoManager jInfoManager = JobSchedulingInfoManager.getInstance(mc, registry);

        Thread thread1 = getThread1(jInfoManager, cLatchCnt1, cLatch1, jInfoManager.getSchedulingInfoObservable("jobId1"));

        Thread thread2 = getThread1(jInfoManager, cLatchCnt2, cLatch2, jInfoManager.getSchedulingInfoObservable("jobId1"));
        thread1.start();
        thread2.start();
        ...
        try {
            ...
            Thread thread4 = getThread1(jInfoManager, cLatchCnt4, cLatch4, jInfoManager.getSchedulingInfoObservable("jobId1"));
            thread4.start();
    ...
    public void testJobSchedulingObsErrorsWithManager() {
        ...
        Thread thread1 = new Thread(() -> jInfoManager.getSchedulingInfoObservable("jobId1")
                .map((d) -> {
        ...
        Thread thread2 = new Thread(() -> jInfoManager.getSchedulingInfoObservable("jobId1")
                .map((d) -> {
                    assertEquals(1, jInfoManager.getSubjectMapSize());
                    return d;
                })
    ...
    Thread getThread1(JobSchedulingInfoManager jInfoManager, int cLatchCnt1, CountDownLatch cLatch1, Observable<JobSchedulingInfo> sObs) {
